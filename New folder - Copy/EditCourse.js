...
const modules = {toolbar: [  [{ header: [1, 2, 3, 4, 5, 6, false] }],  ["bold", "italic", "underline", "blockquote", "code-block"],  [    { list: "ordered" },    { list: "bullet" },    { align: [] },    { indent: "-1" },    { indent: "+1" },  ],  [{ color: [] }, { background: [] }],  ["link", "image"],  ["clean"],],};
...
export default function EditCourse() {
  ...
  useEffect(() => {
    fetch(`http://localhost:3001/courses/${id}`).then((res) => {
      res.json().then((courseInfo) => {
        // console.log(courseInfo);
        setTitle(courseInfo.title);
        setOverview(courseInfo.overview);
        setOutcome(courseInfo.outcome);
        // setContent("");
        setRequirements(courseInfo.requirements);
        setDifficulty(courseInfo.difficulty);
        setFees(courseInfo.fees);
        setContentAccordionItems(JSON.parse(courseInfo.content));
        setQuestions(JSON.parse(courseInfo.quiz));
      });
    });
  }, [id]);
  ...
  async function editCourse(e) {
    ...
    if (  !title ||  !overview ||  !outcome ||  !content ||  !requirements ||  !difficulty ||  !fees ||  !quizQuestions) {
  ...
  return (
    <>
      <header>
        <h1 className="mb-3 fw-bold head">Edit Course</h1>
        <p>
        ...
        >
          ...
          <div>
            ...
            <div>
                    ...
                    <div  id={`collapse-${id}`}  className="accordion-collapse collapse"  aria-labelledby={`heading-${id}`}  data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        ...
                        <div className="text-center">
                          <button  type="button"  className="btn btn-danger btn-sm px-3 py-1"  onClick={() => handleRemoveItem(id)}>
              ...
              <div className="text-center">
                <button  type="button"  className="btn btn-dark mt-3"  data-bs-toggle="modal"  data-bs-target="#addItemModal">  Add Item </button>
              </div>
                 ...
                 <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-footer">
                      ...
                      <button  type="button"  className="btn btn-primary"  onClick={handleAddItem}  data-bs-dismiss="modal">  Add Item</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
            ...
            <ReactQuill  className="margin"  theme="snow"  modules={modules}  formats={formats}  value={requirements}  onChange={(value) => setRequirements(value)}  placeholder="Requirements"/>
          </div>
          ...
          <div>
            ...
            <div className="accordion mt-3" id="accordionExample">
                  ...
                  <div className="accordion-item" key={index}>
                    ...
                    <div  id={`collapse-${index}`}  className="accordion-collapse collapse"  aria-labelledby={`heading-${index}`}  data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        ...
                        <div className="text-center">
                          <button  type="button"  className="btn btn-danger btn-sm px-3 py-1"  onClick={() => handleRemoveQuestion(index)}>
                            <i className="bx bx-trash"></i>
                          </button>
                        </div>
                      </div>
              ...
              {/* Add Question button */}
              <div className="text-center">
                <button  type="button"  className="btn btn-dark mt-3"  data-bs-toggle="modal"  data-bs-target="#addQuestionModal">
                  Add Question
                </button>
              </div>
                  ...
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <div className="mb-3">
                        ...
                        <input  type="text"  className="form-control"  id="questionInput"  value={newQuestion.question}  onChange={handleQuestionChange}/>
                      </div>
                      <div className="mb-3">
                        <label htmlFor="newOptionAInput" className="form-label">
                          Option A
                        </label>
                        <input  type="text"  className="form-control"  id="newOptionAInput"  value={newQuestion.options.a}  onChange={(e) => handleOptionChange(e, "a")}/>
                      </div>
                      <div className="mb-3">
                        <label htmlFor="newOptionBInput" className="form-label">
                          Option B
                        </label>
                        <input  type="text"  className="form-control"  id="newOptionBInput"  value={newQuestion.options.b}  onChange={(e) => handleOptionChange(e, "b")}/>
                      </div>
                      <div className="mb-3">
                        <label htmlFor="newOptionCInput" className="form-label">
                          Option C
                        </label>
                        <input  type="text"  className="form-control"  id="newOptionCInput"  value={newQuestion.options.c}  onChange={(e) => handleOptionChange(e, "c")}/>
                      </div>
                      <div className="mb-3">
                        <label htmlFor="newOptionDInput" className="form-label">
                          Option D
                        </label>
                        <input  type="text"  className="form-control"  id="newOptionDInput"  value={newQuestion.options.d}  onChange={(e) => handleOptionChange(e, "d")}/>
                      </div>
                      <div className="mb-3">
                        <label htmlFor="answerOptions" className="form-label">
                          Answer Options
                        </label>
                        <label className="mx-1">
                          <input  type="radio"  name="answerOptions"  value="a"  checked={newQuestion.answer === "a"}  onChange={handleAnswerChange}/>A
                        </label>
                        <label className="mx-1">
                          <input  type="radio"  name="answerOptions"  value="b"  checked={newQuestion.answer === "b"}  onChange={handleAnswerChange}/>B
                        </label>
                        <label className="mx-1">
                          <input  type="radio"  name="answerOptions"  value="c"  checked={newQuestion.answer === "c"}  onChange={handleAnswerChange}/>C
                        </label>
                        <label className="mx-1">
                          <input  type="radio"  name="answerOptions"  value="d"  checked={newQuestion.answer === "d"}  onChange={handleAnswerChange}/>D
                        </label>
                      </div>
                    </div>
                    <div className="modal-footer">
          ...
          <div>
            ...
            <input  type="text"  id="fees"  className="form-control"  value={fees}  onChange={(e) => setFees(e.target.value)}  placeholder="Course Fees"/>
          </div>
          <div>
